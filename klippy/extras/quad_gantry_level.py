...
class QuadGantryLevel:
    ...
    def probe_finalize(self, offsets, positions):
        ...
        ppx0 = [positions[indexes[0]][0] + offsets[0], z_positions[indexes[0]]]
        ppx3 = [positions[indexes[3]][0] + offsets[0], z_positions[indexes[3]]]
        slope_x_pp03 = self.linefit(ppx0, ppx3)
        # Calculate slope along X axis between probe point 1 and 2
        ppx1 = [positions[indexes[1]][0] + offsets[0], z_positions[indexes[1]]]
        ppx2 = [positions[indexes[2]][0] + offsets[0], z_positions[indexes[2]]]
        ...
        a1 = [positions[indexes[0]][1] + offsets[1],
              self.plot(slope_x_pp03, self.gantry_corners[0][0])]
        a2 = [positions[indexes[1]][1] + offsets[1],
        ...
        b1 = [positions[indexes[0]][1] + offsets[1],
              self.plot(slope_x_pp03, self.gantry_corners[1][0])]
        b2 = [positions[indexes[1]][1] + offsets[1],
